...
CAST(tot_edif as int64) AS Total_Edificacoes,
...
CAST(AREA_EXISTENTE_DECLARADA_RESPONSAVEL AS FLOAT64) AS Area_Existente_Declarada_Responsavel,
...
CAST(VagasExternasDescobertas AS INT64) AS Vagas_Externas_Descobertas,
CAST(VagasExternasCobertas AS INT64) AS Vagas_Externas_Cobertas,
CAST(VagasPavimentos AS INT64) AS Vagas_Pavimentos,
...
CAST(Totalunidades AS INT64) AS Total_Unidades,
CAST(LicOnLine_ID_Requerimento AS INT64) AS ID_Requerimento_Licenca_OnLine
