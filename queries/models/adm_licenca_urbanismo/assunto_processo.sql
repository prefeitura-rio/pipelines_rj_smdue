SELECT
    ...
    CAST(CAST(Exige_Endereco AS FLOAT64) AS INT64) AS exige_endereco,
    CAST(CAST(Exige_ProcessoConstrucao AS FLOAT64) AS INT64) AS exige_processo_construcao,
    CAST(CAST(Exige_CPF_CNPJ_Requerente AS FLOAT64) AS INT64) AS exige_CPF_CNPJ_requerente,
